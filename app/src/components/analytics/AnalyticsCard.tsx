...
const AnalyticsCard: React.FC<AnalyticsCardProps> = ({ user }) => {
  ...
  useEffect(() => {
    ...
    for (let i = 6; i >= 0; i--) {
      ...
      promptCounts.push(user.stats.dailyPrompts[dateString] || 0);
      energyData.push(user.stats.dailyEnergy[dateString] || 0);
    }
